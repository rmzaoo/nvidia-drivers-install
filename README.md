...
```
bash <(curl -s https://raw.githubusercontent.com/rmzaoo/nvidia-drivers-install/master/nvidia-update.sh)
```
...
```
bash <(curl -s hhttps://raw.githubusercontent.com/rmzaoo/nvidia-drivers-install/master/nvidia-update.sh) <revision>
```
...
```
curl -O https://raw.githubusercontent.com/rmzaoo/nvidia-drivers-install/master/nvidia-update.sh
